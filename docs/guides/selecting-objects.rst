...
.. todo::
   ...
   Screenshot: the "Add Objects" tree picker, showing the "Show only finished parts" checkbox,
   a grayed-out already-selected item, and the "Or reference by name/label" field.
